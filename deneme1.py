...
class SolarPanel:
    ...
    def load_model(self, model_name):
        ...
        """
        if model_name:
            model = torch.hub.load('C:/Users/darkr/Desktop/all/gö2/Yeni klasör/yolo/yolov5', 'custom', path=model_name, source="local")
        # else:
...
detector = SolarPanel(capture_index=0, model_name='C:/Users/darkr/Desktop/gö2/Yeni klasör/best_600.pt')
detector()